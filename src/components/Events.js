...
const Events = () => {
    ...
    return (
        <div id="events" className='w-full  h-auto flex flex-col py-[110px] pb-10 '>
            <div className='w-full flex items-center justify-center pb-5'>
                {/* <h1 className='w-full flex items-center justify-center font-bold text-[40px] pb-4'>EVENTS</h1> */}
                <div className='w-auto flex flex-col items-center justify-center'>
                    <h1 className='w-full flex items-center justify-center font-bold text-[40px]' data-aos="fade-up">EVENTS</h1>
            ...
            <div className='flex flex-col md:px-20 h-auto'>
                    ...
                    <div className='w-full md:w-1/2  px-10 md:px-0'>
                        <div className='w-full flex items-center justify-center'>
                            <div className='flex basis-[400px]'>
                                <img src={festival2} alt="" className='w-[100%] h-[310px] object-cover' />
                            </div>
                        </div>
                    </div>
                    <div className='w-full md:w-1/2 flex flex-col pl-5 pr- py-2'>
                        <h3 className='w-full flex justify-center items-center'>FESTIVALS</h3>
                ...
                <div className='flex flex-col md:flex-row mt-5 items-center justify-center'>
                    ...
                    <div className='w-full md:w-1/2 flex flex-col pl-5 pr-3 py-2'>
                        <h3 className='w-full flex justify-center items-center'>GENERAL CHAMPIONSHIP</h3>
                        <p className='text-lg flex flex-wrap ' data-aos="fade-up">
                    ...
                    <div className='w-full md:w-1/2 px-10 md:px-0'>
                        <div className='w-full flex items-center justify-center'>
                            <div className='flex basis-[400px]'>
                                <img src={gc3} alt="" className='w-[100%] h-[310px] object-cover' />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className='flex flex-col md:flex-row mt-5 items-center justify-center'>
                    <div className='w-full md:w-1/2 px-10 md:px-0'>
                        <div className='w-full flex items-center justify-center'>
                            <div className='flex basis-[400px]'>
                                <img src={samagam1} alt="" className='w-[100%] h-[310px] object-cover' />
                            </div>
                        </div>
                    </div>
                    <div className='w-full md:w-1/2 flex flex-col pl-5 pr-3 py-2'>
                        <h3 className='w-full flex items-center justify-center'>SAMAGAMS</h3>
                        <p className='text-lg flex flex-wrap ' data-aos="fade-up">
