...
const Footer = () => {
    return (
        <div className='h-auto'>
            <div className='min-h-[600px] sm:min-h-[300px] bg-[#333333] px-20 flex flex-col sm:flex-row py-10'>
            ...
            <div className='h-[100px] bg-[#222222] flex items-center justify-center text-[#AAAAAA]'>
