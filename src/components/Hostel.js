        ...
        <div id="hostel" className='w-full  h-auto flex flex-col py-[110px] pb-20'>
            <div className='w-full flex items-center justify-center'>
                ...
                <div className='w-auto flex flex-col items-center justify-center pb-4'>
                    <h1 className='w-full flex items-center justify-center font-bold text-[40px]' data-aos="fade-up">FACILITIES</h1>
            ...
            <div className='flex flex-col md:px-20 h-auto'>
                <div className='h-auto flex flex-col md:flex-row rounded-2xl'>
                            ...
                            <Carousel.Item interval={3000}>
                                ...
                                <div className='w-full flex items-center justify-center'>
                                    <div className='flex basis-[500px]'>
                                        <img src={raavi} alt="" className='w-[100%] h-[410px] object-cover' />
                                    </div>
                                </div>
                            </Carousel.Item>
                            <Carousel.Item interval={3000}>
                                ...
                                <div className='w-full flex items-center justify-center'>
                                    <div className='flex basis-[500px]'>
                                        <img src={sutlej} alt="" className='w-[100%] h-[410px] object-cover' />
                                    </div>
                                </div>
                            </Carousel.Item>
                            <Carousel.Item interval={3000}>
                                ...
                                <div className='w-full flex items-center justify-center'>
                                    <div className='flex basis-[500px]'>
                                        <img src={hostel_inside} alt="" className='w-[100%] h-[410px] object-cover' />
                                    </div>
                                </div>
                            </Carousel.Item>
                            <Carousel.Item interval={3000}>
                                ...
                                <div className='w-full flex items-center justify-center'>
                                    <div className='flex basis-[500px]'>
                                        <img src={rooms} alt="" className='w-[100%] h-[410px] object-cover' />
                                    </div>
                                </div>
                            </Carousel.Item>
                    ...
                    <div className='w-full md:w-1/2  px-4 bg-white rounded-xl'>
                ...
                <div className='h-auto flex flex-col  md:flex-row mt-10 md:mt-20  rounded-2xl'>
                    ...
                    <div className='w-full md:w-1/2 bg-white rounded-xl px-4'>
                    ...
                    <div className='w-full md:w-1/2 flex items-center justify-center px-10'>
                        <Carousel>
                            <Carousel.Item interval={3000}>
                                ...
                                <div className='w-full flex items-center justify-center'>
                                    <div className='flex basis-[500px]'>
                                        <img src={mess} alt="" className='w-[100%] h-[410px] object-cover' />
                                    </div>
                                </div>
                            </Carousel.Item>
                            <Carousel.Item interval={3000}>
                                ...
                                <div className='w-full flex items-center justify-center'>
                                    <div className='flex basis-[500px]'>
                                        <img src={mess_interior} alt="" className='w-[100%] h-[410px] object-cover' />
                                    </div>
                                </div>
                            </Carousel.Item>
                        </Carousel>
